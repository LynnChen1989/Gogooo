...
// EmployeeGetter 接口中嵌入了 PeopleGetter 接口，EmployeeGetter将获取PeopleGetter的所有方法
...
// 我来理一下： 因为Employee实现了GetName和GetAge两个方法， 接口PeopleGetter和EmployeeGetter调用了这两个由Employee实现的方法，
// 所以就说，Employee实现了两个接口PeopleGetter和EmployeeGetter， 麻痹真是绕晕了。
